...
# Data specifications
parser.add_argument('--data_root', type=str, default='TO your datasets path', help='dataset directory')
...
parser.add_argument("--size", default=512, type=int, help='cropped patch size')
